...
Don't want to build from source? Get the signed installer, lifetime updates and setup support for a one-time payment at [onetimesuite.com/sigcraft](https://onetimesuite.com/sigcraft/) — same app, MIT source right here.
